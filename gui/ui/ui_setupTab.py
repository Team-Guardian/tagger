...
class Ui_SetupTab(object):
    def setupUi(self, SetupTab):
        ...
        self.button_interopConnect = QtWidgets.QPushButton(self.group_generalSettings)
        self.button_interopConnect.setEnabled(False)
        self.button_interopConnect.setObjectName("button_interopConnect")
        self.horizontalLayout.addWidget(self.button_interopConnect)
        self.button_interopDisconnect = QtWidgets.QPushButton(self.group_generalSettings)
        self.button_interopDisconnect.setEnabled(False)
        self.button_interopDisconnect.setObjectName("button_interopDisconnect")
        self.horizontalLayout.addWidget(self.button_interopDisconnect)
    ...
    def retranslateUi(self, SetupTab):
        ...
        self.checkbox_interopSupport.setText(_translate("SetupTab", "Enable Interop"))
        self.button_interopConnect.setText(_translate("SetupTab", "Connect"))
        self.button_interopDisconnect.setText(_translate("SetupTab", "Disconnect"))
