...
class Ui_SetupTab(object):
    def setupUi(self, SetupTab):
        ...
        self.gridLayout.addWidget(self.line_siteElevation, 1, 1, 1, 2)
        self.line_locationName = QtWidgets.QLineEdit(self.groupBox)
        self.line_locationName.setObjectName("line_locationName")
        self.gridLayout.addWidget(self.line_locationName, 0, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.edit_flightDate, 2, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.button_createFlight, 4, 2, 1, 1)
