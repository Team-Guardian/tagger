...
class Ui_SetupTab(object):
    def setupUi(self, SetupTab):
        ...
        self.checkbox_interopSupport = QtWidgets.QCheckBox(self.groupBox_3)
        ...
        self.checkbox_folderWatcher = QtWidgets.QCheckBox(self.groupBox_3)
