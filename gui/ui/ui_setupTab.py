...
class Ui_SetupTab(object):
    def setupUi(self, SetupTab):
        ...
        self.select_areaMap = QtWidgets.QToolButton(self.groupBox)
        self.select_areaMap.setObjectName("select_areaMap")
        self.gridLayout.addWidget(self.select_areaMap, 4, 3, 1, 1)
    ...
    def retranslateUi(self, SetupTab):
        ...
        self.select_areaMap.setText(_translate("SetupTab", "..."))
