...
class Ui_TaggingTab(object):
    def setupUi(self, TaggingTab):
        ...
        self.image_status_tabs = QtWidgets.QTabWidget(self.groupBox_3)
        self.image_status_tabs.setTabPosition(QtWidgets.QTabWidget.North)
        self.image_status_tabs.setTabShape(QtWidgets.QTabWidget.Rounded)
        self.image_status_tabs.setElideMode(QtCore.Qt.ElideNone)
        self.image_status_tabs.setDocumentMode(False)
        self.image_status_tabs.setTabsClosable(False)
        self.image_status_tabs.setObjectName("image_status_tabs")
        self.reviewed_tab = QtWidgets.QWidget()
        self.reviewed_tab.setEnabled(True)
        self.reviewed_tab.setAutoFillBackground(False)
        self.reviewed_tab.setObjectName("reviewed_tab")
        self.reviewed_list = QtWidgets.QListWidget(self.reviewed_tab)
        self.reviewed_list.setGeometry(QtCore.QRect(0, 0, 341, 181))
        self.reviewed_list.setResizeMode(QtWidgets.QListView.Fixed)
        self.reviewed_list.setObjectName("reviewed_list")
        self.image_status_tabs.addTab(self.reviewed_tab, "")
        self.not_reviewed_tab = QtWidgets.QWidget()
        self.not_reviewed_tab.setObjectName("not_reviewed_tab")
        self.not_reviewed_list = QtWidgets.QListWidget(self.not_reviewed_tab)
        self.not_reviewed_list.setGeometry(QtCore.QRect(0, 0, 561, 271))
        self.not_reviewed_list.setObjectName("not_reviewed_list")
        self.image_status_tabs.addTab(self.not_reviewed_tab, "")
        self.all_images_tab = QtWidgets.QWidget()
        self.all_images_tab.setObjectName("all_images_tab")
        self.all_images_list = QtWidgets.QListWidget(self.all_images_tab)
        self.all_images_list.setGeometry(QtCore.QRect(0, 0, 341, 181))
        self.all_images_list.setObjectName("all_images_list")
        self.image_status_tabs.addTab(self.all_images_tab, "")
        self.verticalLayout_3.addWidget(self.image_status_tabs)
        ...
        self.image_status_tabs.setCurrentIndex(0)
    ...
    def retranslateUi(self, TaggingTab):
        ...
        self.image_status_tabs.setTabText(self.image_status_tabs.indexOf(self.reviewed_tab), _translate("TaggingTab", "Reviewed"))
        self.image_status_tabs.setTabText(self.image_status_tabs.indexOf(self.not_reviewed_tab), _translate("TaggingTab", "Not Reviewed"))
        self.image_status_tabs.setTabText(self.image_status_tabs.indexOf(self.all_images_tab), _translate("TaggingTab", "All Images"))
